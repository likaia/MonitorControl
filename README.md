...
Go to [Releases](https://github.com/likaia/MonitorControl/releases) and download the latest `.dmg` built for macOS 26, or install via Homebrew:
```shell
brew install --cask monitorcontrol
```

For maintainers, a ready-to-copy release note template is available here: [RELEASE_TEMPLATE.md](RELEASE_TEMPLATE.md).
